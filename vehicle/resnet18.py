...
#)
model.fc = nn.Linear(in_features=model.fc.in_features, out_features=len(class_to_index), bias=True)
print(model)
...
save_name = "vehicle_resnet50"


train_model(model, dataloaders, criterion, optimizer, scheduler, num_epochs=25, save_dir = save_dir, prefix = save_name)
